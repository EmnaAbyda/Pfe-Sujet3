...
export class MainComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (localStorage.getItem('token') != null)
      this.routeMyAccount=true;
    else
      this.routeMyAccount=false;
  ...
  public changeRouteMyAccount(routeMyAccount){
    this.routeMyAccount = routeMyAccount;
  }
